...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0002_rename_allocated_days_leavebalance_allocated_days_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='leave',
            name='leave_Status',
            field=models.CharField(choices=[('Pending', 'Pending Status'), ('Approved', 'Approved Status'), ('Declined', 'Declined Status'), ('Cancelled', 'Cancelled Status')], default='Pending', max_length=10),
        ),
